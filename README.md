...
[**Fibonacci Sequence**](https://github.com/MattCairns/Projects/blob/master/Numbers/fibonacci.py) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Credit Card Validator**](https://github.com/MattCairns/Projects/blob/master/Numbers/creditCardValidator.py) - Takes in a credit card number from a common credit card vendor (Visa, MasterCard, American Express, Discoverer) and validates it to make sure that it is a valid number (look into how credit cards use a checksum).
...
[**Reverse a String**](https://github.com/MattCairns/Projects/blob/master/Text/reversestring.py) - Enter a string and the program will reverse it and print it out.

[**Pig Latin**](https://github.com/MattCairns/Projects/blob/master/Text/piglatin.py) - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](https://github.com/MattCairns/Projects/blob/master/Text/countvowels.py) - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/MattCairns/Projects/blob/master/Text/palindrome.py) - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](https://github.com/MattCairns/Projects/blob/master/Text/countwords.py) - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
...
[**Port Scanner**](https://github.com/MattCairns/Projects/blob/master/Networking/portscanner.py) - Enter an IP address and a port range where the program will then attempt to find open ports on the given computer by connecting to each of them. On any successful connections mark the port as open.

**Mail Checker (POP3 / IMAP)** - The user enters various account information include web server and IP, protocol type (POP3 or IMAP) and the application will check for email at a given interval.

[**Country from IP Lookup*](https://github.com/MattCairns/Projects/blob/master/Networking/countryip.py)* - Enter an IP address and find the country that IP is registered in. *Optional: Find the Ip automatically.*

[**Whois Search Tool**](https://github.com/MattCairns/Projects/blob/master/Networking/whois.py) - Enter an IP or host address and have it look it up through whois and return the results to you.
...
[**Get Atomic Time from Internet Clock**](https://github.com/MattCairns/Projects/blob/master/Web/time.py) - This program will get the true atomic time from an atomic time clock on the Internet. Use any one of the atomic clocks returned by a simple Google search.
